...
// Обрабатывает проверку заполнения реквизитов.
//
// Параметры:
...
//
// Описание:
//  Удаляет из списка проверяемых реквизитов "Валюта", если по организации не ведется валютный учет.
//  Для этого использует функцию ПолучитьФункциональнуюОпцию с параметром "ВалютныйУчет" и структурой,
//  содержащей организацию.
//
